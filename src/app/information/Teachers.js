...
import { createTeacher, deleteTeacher, getTeachers, updateTeacher } from "../api/db-crud";

import { mdiContentSave, mdiClose, mdiBookOpenBlankVariant, mdiTestTube, mdiNetworkPos } from '@mdi/js';
    ...
    <div>
                  ...
                  <thead>
                    <tr style={{
                      ...
                      <th style={{
                        ...
                        <Icon path={mdiBookOpenBlankVariant} size={1} style={{ marginRight: "8px", verticalAlign: "middle" }} />
                        Theory
                      </th>
                      <th style={{
                        padding: "18px 20px",
                        ...
                        <Icon path={mdiNetworkPos} size={1} style={{ marginRight: "8px", verticalAlign: "middle" }} />
                        Sessional
                      </th>
                      <th style={{
                        padding: "18px 20px",
                        ...
                        <div style={{ border: '1px solid #eee', borderRadius: 6, marginTop: 2, background: '#fff', zIndex: 10, position: 'absolute', width: '90%' }}>
                          {filteredSuggestions.slice(0, 5).map((suggestion, idx) => (
                            <div
                              ...
                              onClick={() => {
                                setSelectedTeacher({ ...selectedTeacher, designation: suggestion });
                  ...
                  <Col className="px-2 py-1 d-flex align-items-center">
                    <div className="form-check d-flex align-items-center">
                      ...
                      <label className="form-check-label mb-0" style={{ cursor: "pointer", fontWeight: "500", color: "#333", marginLeft: 0 }}>
                        Full Time Status : {selectedTeacher.full_time_status ? "FULL TIME" : "PART TIME"}
                      </label>
                    </div>
                  </Col>
                </Row>
          ...
          <Modal.Footer style={{ borderTop: "none", padding: "0 2rem 1.5rem 2rem", background: "#f8f9fa" }}>
            <Button
              ...
              onClick={() => {
                ...
                setFilteredSuggestions([]); // Clear suggestions when modal is closed
              }}
            >
      ...
      >
        ...
        >
          <div className="d-flex align-items-center">
            ...
            <Modal.Title style={{ fontSize: "18px", fontWeight: "600", color: "#dc3545" }}>Delete Teacher</Modal.Title>
          </div>
        </Modal.Header>
        <Modal.Body className="px-4 py-4">
          <p>Are you sure you want to delete: {deleteTeacherSelected}</p>
      ...
      >
        <Modal.Header style={{
          ...
          <Modal.Title>
            <i className="mdi mdi-cash-multiple" style={{ fontSize: "20px", color: "white", marginRight: "8px" }}></i>
            Map Credit by Designation
          </Modal.Title>
        </Modal.Header>
        <Modal.Body style={{ background: "#f8f9fa", borderRadius: "0 0 20px 20px", padding: "2rem 2rem 0 2rem" }}>
          <div style={{ background: "#fff", borderRadius: "16px", boxShadow: "0 4px 24px rgba(174, 117, 228, 0.08)", padding: "2rem 1.5rem", marginBottom: "1.5rem" }}>
            <Form>
              ...
              <FormGroup className="mt-3">
                <Form.Label style={{ fontWeight: 600, color: "#7c4fd5" }}>Credit Hour</Form.Label>
                <FormControl
                  type="number"
                  value={mapCredit}
