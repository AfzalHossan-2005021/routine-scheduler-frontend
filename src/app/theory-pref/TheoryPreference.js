                    ...
                    <thead>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <path
                              d="M20 21V19C20 17.9391 19.5786 16.9217 18.8284 16.1716C18.0783 15.4214 17.0609 15 16 15H8C6.93913 15 6 15.9391 6 17V19"
                                    ...
                                    <Form.Select
                                      ...
                                      style={{
                                        ...
                                        background:
                                          course.teachers &&
                                          course.teachers[teacherIndex]
                                            ? "linear-gradient(to right, rgba(182, 109, 255, 0.1), rgba(255, 255, 255, 0.9))"
                                            : "#fff",
                                        color:
                                          course.teachers &&
                                          course.teachers[teacherIndex]
                                        ...
                                        boxShadow:
                                          course.teachers &&
                                          course.teachers[teacherIndex]
                                            ? "0 4px 12px rgba(174, 117, 228, 0.1)"
                                            : "none",
                                      ...
                                      onChange={(e) => {
                                        ...
                                        const isAlreadyAssigned =
                                          ...
                                          course.teachers.some(
                                            (t) => t.initial === newInitial
                                          );
                                        if (isAlreadyAssigned) {
                                          toast.error(
                                            `${newName} (${newInitial}) is already assigned to this course`
                                          );
                                          return;
                                        }
                                          ...
                                          const existingCourses =
                                            status.assignment.filter(
                                              (c) =>
                                                ...
                                                c.teachers.some(
                                                  (t) =>
                                                    t.initial === newInitial
                                                )
                                            );
                                          if (existingCourses.length > 0) {
                                            toast(
                                              `${newName} (${newInitial}) is already assigned to ${existingCourses
                                                .map((c) => c.course_id)
                                                .join(", ")}`,
                                              { icon: "⚠️" }
                                            );
                                        ...
                                        setTeacherAssignment({
                                          ...
                                          setStatus((prev) => ({
                                            ...prev,
                                            assignment: prev.assignment.map(
                                              (c, j) =>
                                                j === index
                                                  ? {
                                                      ...c,
                                          ...
                                          toast.success(
                                            `Assigned ${newName} (${newInitial}) to ${course.course_id}`
                                          );
                                        });
                                      }}
                                      disabled={
                    ...
                    <tbody>
                      {allTheoryTeacherAssignment.map((course) =>
                        course.sections.map((section, index) => (
                          <tr
                            key={`${course.course_id}-${section.section}`}
                            style={{
                          ...
                          >
                            {index === 0 && (
                              <td
                                rowSpan={course.sections.length}
                                style={{
                                  verticalAlign: "middle",
                                  fontWeight: "bold",
                                }}
